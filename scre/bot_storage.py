...
from scre.player import BotPlayer, BotJsonMeta
from scre.utils import levenshtein_dist, download_extract_zip, download_file
...
class SscaitBotStorage(BotStorage):
    ...
    def find_bot(self, name: str) -> Optional[BotPlayer]:
        try:
            ...
            if not os.path.exists(f"{self.bot_dir}/{matching_name}"):
