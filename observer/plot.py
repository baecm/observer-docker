...
# import pandas as pd
# from observer.logs import find_frames
...
#     def __init__(self, game_dir, game_name, players) -> None:
...
#         try:
#             for idx, frame_file in enumerate(sorted(find_frames(self.game_dir, self.game_name))):
